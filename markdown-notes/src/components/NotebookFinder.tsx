...
const NotebookFinder = ({ collapsed }: NotebookFinderProps) => {
    ...
    return (
        <div className="notebook-finder-container">
            <div className="notebook-finder"
            onClick={() => {setIsNotebookDirOpen(!isNotebookDirOpen)}}
            role="button"
            tabIndex={0}
            ...
            >
                ...
                <div className={`notebook-finder__chevron ${isNotebookDirOpen ? 'notebook-finder__chevron--open' : ''}`} aria-hidden="true" />
            </div>
            <div 
